...
#     MODEL.WEIGHTS output/v2/univs_swint_stage3_f7/model_0099999.pth \
#     OUTPUT_DIR output/v2/univs_swint_stage3_f7/inf_training_100k/vis/yt21_dev/ \
...
#     MODEL.WEIGHTS output/v2/univs_swint_stage3_f7/model_0099999.pth \
#     OUTPUT_DIR output/v2/univs_swint_stage3_f7/inf_training_100k/vis/ovis_dev/ \
...
CUDA_VISIBLE_DEVICES=0 python train_net.py \
    ...
    MODEL.WEIGHTS output/v2/univs_swint_stage3_f7/model_0099999.pth \
    OUTPUT_DIR output/v2/univs_swint_stage3_f7/inf_training_100k/vss/vspw/ \
...
CUDA_VISIBLE_DEVICES=0 python train_net.py \
    ...
    MODEL.WEIGHTS output/v2/univs_swint_stage3_f7/model_0099999.pth \
    OUTPUT_DIR output/v2/univs_swint_stage3_f7/inf_training_100k/vps/vipseg_dev/ \
...
CUDA_VISIBLE_DEVICES=0 python train_net.py \
    ...
    INPUT.LSJ_AUG.SQUARE_ENABLED False \
    MODEL.WEIGHTS output/v2/univs_swint_stage3_f7/model_0099999.pth \
    OUTPUT_DIR output/v2/univs_swint_stage3_f7/inf_training_100k/vos/davis17/ \
...
CUDA_VISIBLE_DEVICES=0 python train_net.py \
    ...
    MODEL.WEIGHTS output/v2/univs_swint_stage3_f7/model_0099999.pth \
    OUTPUT_DIR output/v2/univs_swint_stage3_f7/inf_training_100k/pvos/viposeg_dev/ \
...
CUDA_VISIBLE_DEVICES=0 python train_net.py \
    ...
    MODEL.WEIGHTS output/v2/univs_swint_stage3_f7/model_0099999.pth \
    OUTPUT_DIR output/v2/univs_swint_stage3_f7/inf_training_100k/refvos/davis_dev/ 