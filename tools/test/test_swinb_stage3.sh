CUDA_VISIBLE_DEVICES=0 python train_net.py \
    ...
    OUTPUT_DIR output/stage3/univs_swinb_stage3_wosquare/inf_training_final/vis/yt21_dev/ \
...
CUDA_VISIBLE_DEVICES=0 python train_net.py \
    ...
    MODEL.WEIGHTS output/stage3/univs_swinb_stage3_f7_wosquare_ema.pth \
    OUTPUT_DIR output/stage3/univs_swinb_stage3_wosquare/inf_training_final/vis/ovis_dev/ \
...
CUDA_VISIBLE_DEVICES=0 python train_net.py \
    ...
    MODEL.WEIGHTS output/stage3/univs_swinb_stage3_f7_wosquare_ema.pth \
    OUTPUT_DIR output/stage3/univs_swinb_stage3_wosquare/inf_training_final/vss/vspw/ \
...
CUDA_VISIBLE_DEVICES=0 python train_net.py \
    ...
    MODEL.WEIGHTS output/stage3/univs_swinb_stage3_f7_wosquare_ema.pth \
    OUTPUT_DIR output/stage3/univs_swinb_stage3_wosquare/inf_training_final/vps/vipseg_dev/ \
...
CUDA_VISIBLE_DEVICES=0 python train_net.py \
    ...
    INPUT.MIN_SIZE_TEST 640 \
    MODEL.WEIGHTS output/stage3/univs_swinb_stage3_f7_wosquare_ema.pth \
    OUTPUT_DIR output/stage3/univs_swinb_stage3_wosquare/inf_training_final/vos/davis17/ \
...
CUDA_VISIBLE_DEVICES=0 python train_net.py \
    ...
    MODEL.WEIGHTS output/stage3/univs_swinb_stage3_f7_wosquare_ema.pth \
    OUTPUT_DIR output/stage3/univs_swinb_stage3_wosquare/inf_training_final/pvos/viposeg_dev/ \
...
CUDA_VISIBLE_DEVICES=0 python train_net.py \
    ...
    MODEL.WEIGHTS output/stage3/univs_swinb_stage3_f7_wosquare_ema.pth \
    OUTPUT_DIR output/stage3/univs_swinb_stage3_wosquare/inf_training_final/refvos/davis_dev/ 