...
parent_new = '/'.join(parent.split('/')[:-1])
...
from univs import add_univs_config
...
if __name__ == "__main__":
    parser = default_argument_parser(
        ...
        $ ./analyze_model.py --tasks parameter \\
            --config-file configs/univs/univs_swinl_stage3.yaml
        ...
        $ ./analyze_model.py --num-inputs 100 --tasks flop \\
            --config-file configs/univs_inf/imgs/univs_swint_coco_c1+univs.yaml \\
