...
class DAVISEvaluation(object):
    def __init__(self, davis_root, task, gt_set, sequences='all', resolution='480p', codalab=False):
        """
        ...
        self.task = task
        self.dataset = DAVIS(root=davis_root, task=task, subset=gt_set, sequences=sequences, resolution=resolution, codalab=codalab)
