...
parser.add_argument('--resolution', type=str, help='resolution of input images', default='480p',
...
if os.path.exists(csv_name_global_path) and os.path.exists(csv_name_per_sequence_path):
    ...
    dataset_eval = DAVISEvaluation(davis_root=args.davis_path, task=args.task, gt_set=args.set, resolution=args.resolution)
