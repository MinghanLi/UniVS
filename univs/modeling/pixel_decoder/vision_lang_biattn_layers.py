...
class BiMultiHeadAttention(nn.Module):
    ...
    def forward(self, v, l, attention_mask_l=None):
        ...
        attn_weights_T = attn_weights.transpose(1, 2)  # (bs * 8, seq_len_text, seq_len_img)
...
class VLFuse(torch.nn.Module):
    ...
    def __init__(
        ...
        self.img_dim = img_dim # 256
        self.lang_dim = lang_dim # 768
    ...
    def forward(self, v, l, attention_mask_l=None, task=None):
        l = l.to(v.device)
        return self.b_attn(v, l, attention_mask_l, task)
