...
_PREDEFINED_SPLITS_RAW_VIDEOS_TEST = {
    "custom_images": ("custom_images/raw/", "custom_images/raw/test.json", "ytvis"),
    ...
    "custom_videos_text_internvid": ("custom_videos/raw_text_internvid/", "custom_videos/raw_text_internvid/test.json", "none"),
    # semantic extraction for internvid-flt-1
    "internvid-flt-1": ("internvid/raw/InternVId-FLT_1", "internvid/raw/InternVId-FLT_1.json", "none"),
    "internvid-flt-1-len5-0-10k": ("internvid/raw/InternVId-FLT_1", "internvid/raw/InternVId-FLT_1_len5_0_10k.json", "none"),
    "internvid-flt-1-len5-10-20k": ("internvid/raw/InternVId-FLT_1", "internvid/raw/InternVId-FLT_1_len5_10_20k.json", "none"),
    "internvid-flt-1-len5-20-30k": ("internvid/raw/InternVId-FLT_1", "internvid/raw/InternVId-FLT_1_len5_20_30k.json", "none"),
    "internvid-flt-1-len5-30-40k": ("internvid/raw/InternVId-FLT_1", "internvid/raw/InternVId-FLT_1_len5_30_40k.json", "none"),
    "internvid-flt-1-len5-40-50k": ("internvid/raw/InternVId-FLT_1", "internvid/raw/InternVId-FLT_1_len5_40_50k.json", "none"),
    "internvid-flt-1-len5-50-60k": ("internvid/raw/InternVId-FLT_1", "internvid/raw/InternVId-FLT_1_len5_50_60k.json", "none"),
    "internvid-flt-1-len5-60-70k": ("internvid/raw/InternVId-FLT_1", "internvid/raw/InternVId-FLT_1_len5_60_70k.json", "none"),
    "internvid-flt-1-len5-70-80k": ("internvid/raw/InternVId-FLT_1", "internvid/raw/InternVId-FLT_1_len5_70_80k.json", "none"),
    "internvid-flt-1-len5-80-90k": ("internvid/raw/InternVId-FLT_1", "internvid/raw/InternVId-FLT_1_len5_80_90k.json", "none"),
    "internvid-flt-1-len5-90-100k": ("internvid/raw/InternVId-FLT_1", "internvid/raw/InternVId-FLT_1_len5_90_100k.json", "none"),
    # missed some long videos (more than 500 frames)
    "internvid-flt-1-len5-specified-videos": ("internvid/raw/InternVId-FLT_1", "internvid/raw/InternVId-FLT_1_len5_specified_videos.json", "none"),
    # semantic extraction for pexel
    "pexel-len6-0": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_0_cocovid.json", "none"),
    "pexel-len6-1": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_1_cocovid.json", "none"),
    "pexel-len6-2": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_2_cocovid.json", "none"),
    "pexel-len6-3": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_3_cocovid.json", "none"),
    "pexel-len6-4": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_4_cocovid.json", "none"),
    "pexel-len6-5": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_5_cocovid.json", "none"),
    "pexel-len6-6": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_6_cocovid.json", "none"),
    "pexel-len6-7": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_7_cocovid.json", "none"),
    "pexel-len6-8": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_8_cocovid.json", "none"),
    "pexel-len6-9": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_9_cocovid.json", "none"),
    "pexel-len6-10": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_10_cocovid.json", "none"),
    "pexel-len6-11": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_11_cocovid_left.json", "none"),
    "pexel-len6-12": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_12_cocovid.json", "none"),
    "pexel-len6-13": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_13_cocovid_left.json", "none"),
    "pexel-len6-14": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_14_cocovid_left.json", "none"),
    "pexel-len6-15": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_15_cocovid_left.json", "none"),
    "pexel-len6-16": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_16_cocovid.json", "none"),
    "pexel-len6-17": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_17_cocovid.json", "none"),
    "pexel-len6-18": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_18_cocovid.json", "none"),
    "pexel-len6-19": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_19_cocovid.json", "none"),
    "pexel-len6-20": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_20_cocovid_left.json", "none"),
    "pexel-len6-21": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_21_cocovid_left.json", "none"),
    "pexel-len6-22": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_22_cocovid_left.json", "none"),
    "pexel-len6-23": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_23_cocovid_left.json", "none"),
    "pexel-len6-24": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_24_cocovid.json", "none"),
    "pexel-len6-25": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_25_cocovid_left.json", "none"),
    "pexel-len6-26": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_26_cocovid_left.json", "none"),
    "pexel-len6-27": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_27_cocovid_left.json", "none"),
    "pexel-len6-28": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_28_cocovid_left.json", "none"),
    "pexel-len6-29": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_29_cocovid_left.json", "none"),
    "pexel-len6-30": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_30_cocovid_left.json", "none"),
    "pexel-len6-31": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_31_cocovid_left.json", "none"),
    "pexel-len6-32": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_32_cocovid.json", "none"),
    "pexel-len6-33": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_33_cocovid.json", "none"),
    "pexel-len6-34": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_34_cocovid.json", "none"),
    "pexel-len6-35": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_35_cocovid.json", "none"),
    "pexel-len6-36": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_36_cocovid.json", "none"),
    "pexel-len6-37": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_37_cocovid.json", "none"),
    "pexel-len6-38": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_38_cocovid.json", "none"),
    "pexel-len6-39": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_39_cocovid.json", "none"),
    "pexel-len6-40": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_40_cocovid.json", "none"),
    "pexel-len6-41": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_41_cocovid.json", "none"),
    "pexel-len6-42": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_42_cocovid.json", "none"),
    "pexel-len6-43": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_43_cocovid.json", "none"),
    "pexel-len6-44": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_44_cocovid.json", "none"),
    "pexel-len6-45": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_45_cocovid.json", "none"),
    "pexel-len6-46": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_46_cocovid.json", "none"),
    "pexel-len6-47": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_47_cocovid.json", "none"),
    "pexel-len6-48": ("pexel/PexelVideos-Full", "pexel/json_files_cocovid/PexelVideos-6s_48_cocovid.json", "none"),
    # test videos for mixtral
    "msr-vtt-test": ("msr-vtt/data/TestVideo", "msr-vtt/data/test_cocovid_1_video_stride_5_frame_stride.json", "none"),
    "internvid-flt-2-0-1000": ("internvid/raw/InternVId-FLT_2", "internvid/csv_files_cocovid/InternVId-FLT_2_0_1000.json", "none"),
}
