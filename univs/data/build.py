...
from .combined_loader import CombinedDataLoader_Epoch, CombinedDataLoader_Iter, CombinedDataLoader_Mix, Loader
...
def build_combined_loader(cfg: CfgNode, loaders: Collection[Loader], ratios: Sequence[float]):
    ...
    if cfg.DATASETS.DATALOADER_TYPE == "iter":
        return CombinedDataLoader_Iter(loaders, images_per_worker, ratios)
    elif cfg.DATASETS.DATALOADER_TYPE == "epoch":
        return CombinedDataLoader_Epoch(loaders, images_per_worker, ratios)
    elif cfg.DATASETS.DATALOADER_TYPE == "mix":
        return CombinedDataLoader_Mix(loaders, images_per_worker, ratios)
