# the code from https://github.com/whai362/PVT
################################################
...
class PyramidVisionTransformerV2(Backbone):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
                 ...
                 sr_ratios=[8, 4, 2, 1], num_stages=4, linear=False, pretrained=None, out_features=None):
        super().__init__()
...
def build_pvtv2_b2_backbone(cfg, input_shape):
    out_features = ["res2", "res3", "res4", "res5"]  # cfg.MODEL.PVTV2.OUT_FEATURES
