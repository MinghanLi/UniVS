...
def parse_args():
    ...
    parser.add_argument("--csv_file", default="datasets/internvid/csv_files/InternVId-FLT_2.csv", type=str, help="")
    parser.add_argument("--video_dir", default="datasets/internvid/raw/InternVId-FLT_2", type=str, help="")
    parser.add_argument("--out_json", default="datasets/internvid/csv_files_cocovid/InternVId-FLT_2.json", type=str, help="")
    parser.add_argument("--start_index", default=0, type=int, help="start index")
    parser.add_argument("--end_index", default=1000, type=int, help="end index")
    parser.add_argument("--is_specified_indices", default=False, type=bool, help="extract specified videos")
    parser.add_argument("--specified_indices", default=[], 
