...
class StrToBytes:
	"""
	load pickle file in python3, but saved in python2 format
	"""
...
class REFER:
	...
	def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
		...
		self.data['refs'] = pickle.load(StrToBytes(open(ref_file, 'r', encoding="ISO-8859-1")))
	...
	def getMask(self, ref):
		...
		# compute area
		area = sum(maskUtils.area(rle))  # should be close to ann['area']
