...
if __name__ == "__main__":
    ...
    for name, dirname in [("train", "training"), ("val", "validation")]:
        ...
        # json config
        config_file = "datasets/data_utils/ade20k_instance_imgCatIds.json"
        with open(config_file) as f:
            config = json.load(f)

        # load catid mapping
        mapping_file = "datasets/data_utils/ade20k_instance_catid_mapping.txt"
        ...
        ADEChallengeData2016_150_CATEGORIES = []
        for cat_id, cat_name in enumerate(ADEChallengeData2016_SEM_SEG_CATEGORIES):
            ADEChallengeData2016_150_CATEGORIES.append(
                {
                    "name": cat_name,
                    "id": cat_id,
        ...
        categories_dict = {cat["id"]: cat for cat in ADEChallengeData2016_150_CATEGORIES}

        panoptic_json_categories = ADEChallengeData2016_150_CATEGORIES[:]
