...
def parse_args():
    ...
    parser.add_argument("--root_dir", default="datasets", type=str, help="directory of ref-youtube-vos")
...
if __name__ == "__main__":
    ...
    data_root = os.path.join(args.root_dir, "objects365/images/")
    anno_root = os.path.join(args.root_dir, "objects365/annotations")
