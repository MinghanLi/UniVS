...
class MaskFormer_Video(nn.Module):
    """
    ...
    def from_config(cls, cfg):
        ...
        if boxvis_enabled:
            weight_dict = {"loss_ce": class_weight, "loss_mask_proj": mask_weight, "loss_mask_pair": 1.,
                           "loss_box": box_weight, "loss_giou": box_weight}
        else:
        ...
        losses = ["labels", "boxes", "masks"] if boxvis_enabled else ["labels", "masks"]
